...
const report={checkedAt:new Date().toISOString(),pages:pages.length,redirects:Object.keys(aliases).length,checks:'Output routes, source titles/descriptions/canonicals, noindex, H1 count, reviewed contact-form markup and locally bundled scripts, local assets, internal links, source text blocks, redirect targets and cycle validation.',failures,warnings,results};

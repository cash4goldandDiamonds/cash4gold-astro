...
export function hostHeaders(policy,features={}){return `/*\n${policy.indexable?'':'  X-Robots-Tag: noindex, nofollow, noarchive\n'}  X-Content-Type-Options: nosniff\n  Referrer-Policy: strict-origin-when-cross-origin\n  X-Frame-Options: SAMEORIGIN\n  Permissions-Policy: camera=(), microphone=(), geolocation=()\n  Cache-Control: ${policy.indexable?'public, max-age=0, must-revalidate':'private, no-store'}\n  Content-Security-Policy: default-src 'self'; script-src 'self' https://challenges.cloudflare.com${features.analytics===true?' https://www.googletagmanager.com':''}${features.cloudflareBeacon===true?' https://static.cloudflareinsights.com':''}; style-src 'self' 'unsafe-inline'; img-src 'self' https://cdn.sanity.io data:${features.analytics===true?' https://www.google-analytics.com https://region1.google-analytics.com':''}; font-src 'self'; connect-src 'self' https://challenges.cloudflare.com${features.analytics===true?' https://www.google-analytics.com https://region1.google-analytics.com https://analytics.google.com':''}${features.cloudflareBeacon===true?' https://cloudflareinsights.com':''}; frame-src https://challenges.cloudflare.com; media-src 'self'; object-src 'none'; base-uri 'self'; form-action 'self'; frame-ancestors 'self'\n${policy.indexable?'/media/*\n  Cache-Control: public, max-age=86400, must-revalidate\n/_astro/*\n  Cache-Control: public, max-age=31536000, immutable\n':''}/locations.kml\n  Content-Type: application/vnd.google-earth.kml+xml; charset=utf-8\n/404.html\n  X-Robots-Tag: noindex, nofollow\n`;
}

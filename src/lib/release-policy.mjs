...
export function hostHeaders(policy){return `/*\n${policy.indexable?'':'  X-Robots-Tag: noindex, nofollow, noarchive\n'}  X-Content-Type-Options: nosniff\n  Referrer-Policy: strict-origin-when-cross-origin\n  X-Frame-Options: SAMEORIGIN\n  Permissions-Policy: camera=(), microphone=(), geolocation=()\n  Cache-Control: ${policy.indexable?'public, max-age=0, must-revalidate':'private, no-store'}\n  Content-Security-Policy: default-src 'self'; script-src 'self'; style-src 'self' 'unsafe-inline'; img-src 'self' https://cdn.sanity.io data:; font-src 'self'; connect-src 'self'; media-src 'self'; object-src 'none'; base-uri 'self'; form-action 'none'; frame-ancestors 'self'\n${policy.indexable?'/media/*\n  Cache-Control: public, max-age=86400, must-revalidate\n/_astro/*\n  Cache-Control: public, max-age=31536000, immutable\n':''}/404.html\n  X-Robots-Tag: noindex, nofollow\n`;
}

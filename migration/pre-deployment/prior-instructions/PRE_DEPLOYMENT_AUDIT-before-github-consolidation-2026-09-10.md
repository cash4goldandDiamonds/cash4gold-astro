...
5. After those dependencies are connected, complete the remaining acceptance runs and final migration delta. Use the existing conditional launch authorization only when the audit is actually ready.

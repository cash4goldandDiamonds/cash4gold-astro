...
September 10, 2026. Preserve the existing Astro/Sanity rebuild in the private `cash4goldandDiamonds/cash4gold-astro` repository, on the existing `audit/pre-deployment-2026-09-10` branch. No production deployment, DNS change, CMS import, live WordPress edit, or social publishing is included.

...
# Home-computer website checkpoint

Saved 2026-09-10T14:28:28.740Z. Work remains in the original Astro/Sanity checkout. The work-PC ZIP and staged copy remain preserved; transfer is deferred. Nothing was pushed, imported into a remote CMS or publicly deployed.

## Completed local content

- 109/109 article bodies reviewed: 99 rewritten, 6 improved, 4 retained. No substantive reviews remain pending.
- 105 preferred guides, each with a distinct card photo; 218 responsive article image placements. The four original near-duplicate article pairs use aligned content and their established preferred canonical URLs. All 109 article locations remain accessible, including the owner-requested redirect, and original publication dates are retained.
...
The final build generated 212 routes. Local checks passed for 196 content pages and 15 configured redirects, all 109 articles, local assets and links, 13 CMS content types, and 403 locally prepared CMS documents. The CMS rich-text projection check passed for 109 articles, 218 images and 2669 preserved anchors, including changed metadata/social images and input-safety checks. Check timestamps are recorded in migration/*-verification.json and migration/verification.json.

The 6 preservation warnings are intentional rewritten source pages, documented in migration/final-source-difference-review.json. They do not represent broken routes or missing assets. The original source evidence remains preserved.

Actual browser checks confirmed the diamond redirect, current heading and canonical, natural-only policy, corrected source links, mobile navigation, 105 guide cards with 105 distinct photos and no horizontal overflow at the inspected narrow viewport. The sound logic passed eight local behavior checks; these are distinct from an audible listening test. The navigation and sound script is 2208 bytes. No Lighthouse score, production Core Web Vitals or ranking measurement is claimed; the required trace tools were unavailable.
